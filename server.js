...
let stock = {
    ...
    torpedos:{
        ...
        especial:{nombre:"2TORPEDOS DE SUPREMAS +FRITA 1/2 DE EMPANADAS", stock:20},
    },
    ...
    suprema:{
        ...
        milanesa:{nombre:"MILANESA DE SUPREMAS ALA NAPOLITANA + FRITA", stock:20},
    ...
    promo:{
        ...
        promo2:{nombre:"Promo 1", stock:10},
        promo3:{nombre:"Promo 1", stock:10},
        promo4:{nombre:"Promo 1", stock:10},
    }
...
io.on("connection",(socket)=>{
    ...
    // manda el stock cuando alguien entra
...
app.post("/actualizar-stock", (req,res)=>{
    ...
    console.log(
        ...
        categoria,
        producto,
        stock[categoria][producto].stock
    );
...
server.listen(3000,()=>{
    ...
    console.log(
        "Servidor Doña salsa en http://localhost:3000"
    );
